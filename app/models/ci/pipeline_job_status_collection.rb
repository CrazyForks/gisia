...
# Todo, copied AtomicProcessingService::StatusCollection
module Ci
  class PipelineJobStatusCollection
    ...
    def stopped_job_names
      all_jobs.select { |job| job[:status].in?(Ci::HasStatus::STOPPED_STATUSES) }.pluck(:name)
    end
