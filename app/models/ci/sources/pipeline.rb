...
module Ci
  module Sources
    class Pipeline < Ci::ApplicationRecord
      ...
      belongs_to :build, class_name: 'Ci::Build', foreign_key: :source_job_id, inverse_of: :sourced_pipelines, optional: true
      ...
      belongs_to :source_bridge, class_name: 'Ci::Bridge', foreign_key: :source_job_id, optional: true
