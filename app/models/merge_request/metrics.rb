...
class MergeRequest::Metrics < ApplicationRecord
  ...
  belongs_to :pipeline, class_name: 'Ci::Pipeline', foreign_key: :pipeline_id, optional: true
  belongs_to :latest_closed_by, class_name: 'User', optional: true
  belongs_to :merged_by, class_name: 'User', optional: true
  belongs_to :target_project, class_name: 'Project', inverse_of: :merge_requests, optional: true
