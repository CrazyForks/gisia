...
module Ci
  ...
  class CreateDownstreamPipelineService < ::BaseService
    ...
    def execute(bridge)
      ...
      downstream_pipeline = Ci::Pipeline.build_from(pipeline_params.fetch(:project), current_user,
        pipeline_params.fetch(:target_revision), pipeline_params.fetch(:source), **pipeline_params[:execute_params])
