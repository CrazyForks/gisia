...
module Notes
  class QuickActionsService < BaseService
    ...
    SUPPORTED_COMMANDS = %i[close reopen open].freeze
    ...
    def execute(note, options = {})
      ...
      interpret_service.execute_with_original_text(
        note.note, note.noteable, only: SUPPORTED_COMMANDS, original_text: old_note
      )
    end
...
Notes::QuickActionsService.prepend(Gisia::Notes::QuickActionsService)
